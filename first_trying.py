...
class Character:
    def __init__(self, *, level: int) -> None:
        self.level = level
        self.health_point = self.base_health_point * level
    ...
    @property
    def max_health_point(self) -> int:
        return self.level * self.base_health_point

    def health_point_precent(self):
        return 100 * self.health_point / self.max_health_point

    def __str__(self):
        return f"{self.character_name} (level: {self.level}, hp: {self.health_point})"
...
class Elf(Character):
    ...
    def attack(self, *, target: "Character") -> None:
        ...
        if target.health_point_precent() < 30:
